...
<body>
	<div class="pb-5">
		...
		<div class="pt-5 pb-5">
			<div align="center">
				<form name="form" action="<%=request.getContextPath()%>/AltaPedido"
					method="post" style="width: 23rem;">
					<h3 class="fw-normal mb-3 pb-3"
						style="letter-spacing: 1px; text-align: center;">
						<font color="sky blue">Alta Pedido</font>
					</h3><h4>
					<span style="color: red"><%=(request.getAttribute("errMessage") == null) ? "" : request.getAttribute("errMessage")%></span>
				</h4>
					<div class="form-outline mb-4">
						<label class="form-label" for="idUsuario"><font
							color="black">ID del usuario</font></label> <input type="number"
							id="idUsuario" class="form-control form-control-lg"
							name="idUsuario" />
					</div>
					<div class="form-outline mb-4">
						<label class="form-label" for="fechaPedido"><font
							color="black">Fecha del pedido</font></label> <input type="date"
							id="fechaPedido" class="form-control form-control-lg"
							name="fechaPedido" placeholder="dd-MM-yyyy" />

					</div>

					<div class="form-outline mb-4">
						<label class="form-label" for="pedidoPrecio"><font
							color="black">Precio del pedido</font></label> <input type="text"
							id="pedidoPrecio" class="form-control form-control-lg"
							name="pedidoPrecio" />
					</div>
